        ...
        "@react-native-google-signin/google-signin",
        {
          iosUrlScheme: process.env.EXPO_PUBLIC_IOS_CLIENT_ID
            ? `com.googleusercontent.apps.${
                process.env.EXPO_PUBLIC_IOS_CLIENT_ID.split(".")[0]
              }`
    ...
    extra: {
      ...
      google: {
        iosClientId:
          ...
          "958080376950-ov7dgq16sggjncpa7u5p4edesradrr0g.apps.googleusercontent.com",
      },
      googleClientId:
        process.env.EXPO_PUBLIC_WEB_CLIENT_ID ||
        "958080376950-ii8vapnkoq7r9s7ji8ps55fh09ie47m7.apps.googleusercontent.com",
